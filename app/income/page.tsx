      ...
      <main className="flex-1">
        ...
        <section className="bg-sidebar px-6 py-16 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <Badge className="mb-4 bg-primary/10 text-primary border-primary/20">Financial Freedom</Badge>
            <h1 className="text-4xl font-bold text-sidebar-foreground sm:text-5xl">14 Income Sources</h1>
            <p className="mt-4 text-lg text-muted-foreground">
              Team Chetak ATOMY provides multiple ways to earn and build your financial future. From daily sales to
        ...
        <section className="px-6 py-16 lg:px-8 bg-muted/30">
          <div className="mx-auto max-w-7xl">
            <h2 className="text-2xl font-bold text-foreground text-center mb-10">Income Categories</h2>
        ...
        <section className="bg-sidebar px-6 py-16 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-2xl font-bold text-sidebar-foreground">Start Earning Today</h2>
            <p className="mt-4 text-muted-foreground">
              Join Team Chetak and unlock all 14 income sources with ATOMY network marketing
            </p>
            <a
              href="/join"
